...
parser.add_argument('--dataset', default='YAGO3-10', metavar='',
                    help='which dataset in {`YAGO3-10`, `LitWD48K`, `FB15K-237`} to be used? (default: LitWD48K)')
...
# Load raw literals
df = pd.read_csv(f'data/{args.dataset}/literals/numeric_literal_feature.txt', header=None, sep='\t')
